          ...
          on e:exception do begin
            ...
            TThread.Synchronize(nil,procedure
             begin
               memo2.Lines.Add(e.ToString);
               try
                 QLogPedidosSite.Close;
                 QLogPedidosSite.SQL.Clear;
                 QLogPedidosSite.SQL.Add('insert into LogPedidosSite values(getDate(),:log)');
                 QLogPedidosSite.ParamByName('log').Value := memo2.Text;
                 QLogPedidosSite.ExecSQL;
               finally
